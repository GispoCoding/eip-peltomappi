...
<img src="img/Peltomappi_dokumentaatio_v5.gif"/>


## **Tiedotteet**

**29.1.2026**: Sovelluksessa esiintyy hitautta. Odottelemme lähiajalla päivitystä sovellukseen sovelluksen kehittäjältä.

**28.1.2026**: Dokumentaatiota päivitetty.

**22.1.2026**: Testiversio 3 jaettu käyttäjille.

**15.1.2026**: Dokumentaatio päivitetty

**17.11.2025**: projektitiedostot päivitetty uusiin [ominaisuuksiin](https://gispocoding.github.io/eip-peltomappi/muutosloki.html). Kun projektitiedosto synkronoidaan niin uusin versio latautuu käyttäjille. 
